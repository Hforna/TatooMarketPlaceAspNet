        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TattooImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tattoos_studios_StudioId",
                        column: x => x.StudioId,
                        principalTable: "studios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_reviews_tattoos_TattooId",
                        column: x => x.TattooId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "System.Func`1[System.Guid]", new DateTime(2024, 11, 9, 3, 36, 23, 16, DateTimeKind.Utc).AddTicks(8663), "seller", "SELLER" },
                    { 2L, "System.Func`1[System.Guid]", new DateTime(2024, 11, 9, 3, 36, 23, 16, DateTimeKind.Utc).AddTicks(8682), "customer", "CUSTOMER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_reviews_TattooId",
                table: "reviews",
                column: "TattooId");

            migrationBuilder.CreateIndex(
                name: "IX_tattoos_StudioId",
                table: "tattoos",
                column: "StudioId");
        }
