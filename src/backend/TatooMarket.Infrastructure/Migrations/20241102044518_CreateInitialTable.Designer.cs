...
namespace TatooMarket.Infrastructure.Migrations
{
    ...
    [Migration("20241102044518_CreateInitialTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TatooMarket.Domain.Entities.Identity.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<long>", b =>
                {
                    b.HasOne("TatooMarket.Domain.Entities.Identity.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TatooMarket.Domain.Entities.Communication.ReviewEntity", b =>
                {
                    b.HasOne("TatooMarket.Domain.Entities.Identity.User", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("TatooMarket.Domain.Entities.Tattoo.Studio", b =>
                {
                    b.HasOne("TatooMarket.Domain.Entities.Identity.User", "Owner")
                        .WithMany()
